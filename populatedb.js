...
console.log('This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: mongodb+srv://zerokira123:password@cluster0.0i4vq.azure.mongodb.net/local_library?retryWrites=true&w=majority');
